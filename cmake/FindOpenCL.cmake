...
ELSE (APPLE)
	...
	IF (WIN32)
		...
		IF (${CMAKE_SYSTEM_PROCESSOR} STREQUAL "AMD64" AND CMAKE_SIZEOF_VOID_P EQUAL 8)
			SET(OPENCL_LIB_DIR "$ENV{AMDAPPSDKROOT}/lib/x86_64")
	    ELSE (${CMAKE_SYSTEM_PROCESSOR} STREQUAL "AMD64" AND CMAKE_SIZEOF_VOID_P EQUAL 8)
			SET(OPENCL_LIB_DIR "$ENV{AMDAPPSDKROOT}/lib/x86")
	    ENDIF (${CMAKE_SYSTEM_PROCESSOR} STREQUAL "AMD64" AND CMAKE_SIZEOF_VOID_P EQUAL 8)
